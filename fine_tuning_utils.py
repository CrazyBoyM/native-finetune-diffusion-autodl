...
def load_models_from_stable_diffusion_checkpoint(v2, ckpt_path, dtype=None):
  ...
  if v2:
    ...
    clip_model_path = os.path.join(os.path.dirname(script_path), "tools/diffusers-models/clip-vit-large-patch14")
    text_model = CLIPTextModel.from_pretrained(clip_model_path)
    info = text_model.load_state_dict(converted_text_encoder_checkpoint)
